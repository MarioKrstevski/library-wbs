  ...
  <nav class="flex items-center justify-between bg-teal-500 p-6">
    <div>
      <router-link class="mr-4" to="/">
        <div
          @contextmenu.prevent="rclickHandler($event)"
        ...
        >
          ...
          <span class="font-semibold text-xl tracking-tight"
            >The British Library</span
          >
        </div>
      </router-link>

      <div class="text-sm lg:flex-grow">
        Welcome to our digital library, we hope you find what you need.
      </div>
    </div>
    <div class="w-full flex-grow flex items-center w-auto">
      <div class="pt-2 relative mx-auto text-gray-600 inline-block mr-4">
        <input
